...
opts.imdbPathtrain = fullfile(opts.dataDir, 'sample_for_SPDNet_UAV.mat'); % get the data
opts.batchSize = 30; % original is 30 
opts.test.batchSize = 1;
opts.numEpochs = 1600; % maximum number of epoches is 500, this can be adjusted
opts.gpus = [] ;   
